...
class GameSprite(sprite.Sprite):
    def __init__(self,playes_image, player_x, player_y, player_speed):
        super().__init__()
        self.image = transform.scale(image.load(playes_image),(65, 65))
...
w1 = Wall(190, 190, 0, 100, 20, 450,10)
w2 = Wall(190, 190, 0, 100, 480, 350,10)
w3 = Wall(190, 190, 0, 100, 20, 10, 380)
